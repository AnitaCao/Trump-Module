...
/**
 * String conversion functions that creates different data-types from String
 * type
 */
public class StringConversionFunction extends FunctionBase {
	 ...
	 */
	public static final String NAME_BOOLEAN_FROM_STRING = FUNCTION_NS_3
			+ "boolean-from-string";

	/**
	 * Standard identifier for the integer-from-boolean function.
	 */
	public static final String NAME_INTEGER_FROM_STRING = FUNCTION_NS_3
			+ "integer-from-string";

	/**
	 * Standard identifier for the integer-from-boolean function.
	 */
	public static final String NAME_DOUBLE_FROM_STRING = FUNCTION_NS_3
			+ "double-from-string";

	/**
	 * Standard identifier for the integer-from-boolean function.
	 */
	public static final String NAME_TIME_FROM_STRING = FUNCTION_NS_3
			+ "time-from-string";

	/**
	 * Standard identifier for the integer-from-boolean function.
	 */
	public static final String NAME_DATE_FROM_STRING = FUNCTION_NS_3
			+ "date-from-string";

	/**
	 * Standard identifier for the integer-from-boolean function.
	 */
	public static final String NAME_DATE_TIME_FROM_STRING = FUNCTION_NS_3
			+ "dateTime-from-string";

	/**
	 * Standard identifier for the integer-from-boolean function.
	 */
	public static final String NAME_URI_FROM_STRING = FUNCTION_NS_3
			+ "anyURI-from-string";

	/**
	 * Standard identifier for the integer-from-boolean function.
	 */
	public static final String NAME_DAYTIME_DURATION_FROM_STRING = FUNCTION_NS_3
			+ "dayTimeDuration-from-string";

	/**
	 * Standard identifier for the integer-from-boolean function.
	 */
	public static final String NAME_YEAR_MONTH_DURATION_FROM_STRING = FUNCTION_NS_3
			+ "yearMonthDuration-from-string";

	/**
	 * Standard identifier for the integer-from-boolean function.
	 */
	public static final String NAME_X500NAME_FROM_STRING = FUNCTION_NS_3
			+ "x500Name-from-string";

	/**
	 * Standard identifier for the integer-from-boolean function.
	 */
	public static final String NAME_RFC822_FROM_STRING = FUNCTION_NS_3
			+ "rfc822Name-from-string";

	/**
	 * Standard identifier for the integer-from-boolean function.
	 */
	public static final String NAME_IP_ADDRESS_FROM_STRING = FUNCTION_NS_3
			+ "ipAddress-from-string";

	/**
	 * Standard identifier for the integer-from-boolean function.
	 */
	public static final String NAME_DNS_FROM_STRING = FUNCTION_NS_3
			+ "dnsName-from-string";
	...
	static {
		...
		dataTypeMap.put(NAME_DATE_TIME_FROM_STRING,
				DateTimeAttribute.identifier);
		dataTypeMap.put(NAME_DAYTIME_DURATION_FROM_STRING,
				DayTimeDurationAttribute.identifier);
		dataTypeMap.put(NAME_YEAR_MONTH_DURATION_FROM_STRING,
				YearMonthDurationAttribute.identifier);
		dataTypeMap.put(NAME_URI_FROM_STRING, AnyURIAttribute.identifier);
		dataTypeMap
				.put(NAME_X500NAME_FROM_STRING, X500NameAttribute.identifier);
		dataTypeMap
				.put(NAME_RFC822_FROM_STRING, RFC822NameAttribute.identifier);
		dataTypeMap.put(NAME_IP_ADDRESS_FROM_STRING,
	...
	public StringConversionFunction(String functionName) {
		super(functionName, 0, StringAttribute.identifier, false, 1,
				getReturnType(functionName), false);
	}

	/**
	 * Private helper that returns the return type used for the given standard
	 * function.
	 * 
	 * @param functionName
	 *            function name
	...
	public EvaluationResult evaluate(List<Evaluatable> inputs,
		...
		try {
			...
			AttributeValue value = Balana.getInstance().getAttributeFactory()
					.createValue(dataType, argValues[0].encode());
