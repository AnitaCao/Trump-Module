...
/**
 * This is used in cases where a normal result is Set of contexts, but if an
 * context couldn't be created or any error is occurred during the creation,
...
public class MultipleCtxResult {
	 ...
	 */
	public MultipleCtxResult(Set<EvaluationCtx> evaluationCtxSet,
			Status status, boolean indeterminate) {
