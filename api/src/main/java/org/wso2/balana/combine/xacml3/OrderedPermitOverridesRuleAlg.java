...
/**
 * This is the new (XACML 3.0) standard Ordered Permit Overrides rule combining
 * algorithm. It allows a single evaluation of Permit to take precedence over
 * any number of deny, not applicable or indeterminate results. Note that this
 * uses the regular Permit Overrides implementation since it is also ordered.
 * 
 */
